<?php include 'includes/header.php';?>
            ...
            <div class="movie-thumb-bg">
              ...
              <div class="api-data">
                ...
                <div class="rotten-row">
                  <div id="rotten-icon" class="rotten-icon rotten-icon0"></div>
          ...
          <div class="portfolio-thumbs">
            <div class="movie-thumb-bg">
              ...
              <div class="api-data">
                <h5>TOMATOMETER<i class="fa fa-question-circle"></i></h5>
                <div class="rotten-row">
                  <div class="rotten-icon rotten-icon1"></div>
          ...
          <div class="portfolio-thumbs">
            <div class="movie-thumb-bg">
              ...
              <div class="api-data">
                <h5>TOMATOMETER<i class="fa fa-question-circle"></i></h5>
                <div class="rotten-row">
                  <div class="rotten-icon rotten-icon2"></div>
          ...
          <div class="portfolio-thumbs">
            <div class="movie-thumb-bg">
              ...
              <div class="api-data">
                <h5>TOMATOMETER<i class="fa fa-question-circle"></i></h5>
                <div class="rotten-row">
                  <div class="rotten-icon rotten-icon3"></div>
          ...
          <div class="portfolio-thumbs">
            <div class="movie-thumb-bg">
              ...
              <div class="api-data">
                <h5>TOMATOMETER<i class="fa fa-question-circle"></i></h5>
                <div class="rotten-row">
                  <div class="rotten-icon rotten-icon4"></div>
  ...
  <!--  <script src="js/require.js"></script>
    <script src="js/oibackoff.js"></script>-->
